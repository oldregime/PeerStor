...
if (1)
	Ls.eng = {
		...
		"login": "Login",
		"access": " access",
		"ot_close": "Close this menu",
		"ot_search": "Search for files by name, type, or date",
		"ot_unpost": "Cancel or undo recent uploads",
		"ot_bup": "Quick upload - drag files here",
		"ot_mkdir": "Create a new folder",
		"ot_md": "Create a new document",
		"ot_msg": "Send a message to the server",
		"ot_mp": "media player options",
		"ot_cfg": "configuration options",
		"ot_u2i": 'Upload files here. You can pause and resume uploads anytime.',
		"ot_u2w": 'Upload files here. You can pause and resume uploads anytime.',
		...
		"wt_ren": "Rename selected files",
		"wt_del": "Delete selected files",
		"wt_cut": "Move files - select destination after",
		"wt_cpy": "Copy files to another folder",
		"wt_pst": "Paste copied or cut files here",
		"wt_selall": "Select everything",
		"wt_selinv": "Reverse selection",
		"wt_zip1": "Download this folder as ZIP",
		"wt_selzip": "Download as ZIP file",
		"wt_seldl": "Download files one by one",
		"wt_npirc": "Copy track info",
		"wt_nptxt": "Copy track info as text",
		...
		"ul_par": "Simultaneous uploads:",
		"ut_rand": "Use random filenames",
		"ut_u2ts": "Keep original file dates\">📅",
		"ut_ow": "If file already exists:$N🛡️: Create new name (safe)$N🕒: Replace if yours is newer$N♻️: Replace if different$N⏭️: Skip existing files",
		"ut_mt": "Speed up by processing multiple files at once",
		"ut_ask": 'Ask for confirmation before uploading">💭',
		"ut_pot": "Simplified mode for slower devices",
		"ut_srch": "Check if files already exist without uploading",
		"ut_par": "Number of files to upload at once$N(Set to 0 to pause uploads)",
		"ul_btn": "Drop files here<br>or click to browse",
		"ul_btnu": "U P L O A D",
		"ul_btns": "S E A R C H",
		...
		"ul_send": "Uploading",
		"ul_done": "Complete",
		"ul_idle1": "No files selected for upload",
		"ut_etah": "File preparation speed and time remaining",
		"ut_etau": "Upload speed and time remaining",
		"ut_etat": "Overall progress and time remaining",

		"uct_ok": "Successfully uploaded",
		"uct_ng": "Failed uploads",
		"uct_done": "Total processed",
		"uct_bz": "Currently uploading",
		"uct_q": "Waiting in queue",

		"utl_name": "File name",
		"utl_ulist": "File list",
		"utl_ucopy": "Copy link",
		"utl_links": "File links",
		"utl_stat": "Status",
		"utl_prog": "Progress",
		...
		"ct_grid": 'Thumbnail view',
		"ct_ttips": 'Show helpful tips">ℹ️ tooltips',
		"ct_thumb": 'Show image previews">🖼️ thumbs',
		"ct_csel": 'Use Ctrl+click to select multiple files">sel',
		"ct_dsel": 'Click and drag to select files">dsel',
		"ct_dl": 'Always download files when clicked">dl',
		"ct_ihop": 'Return to last viewed image">g⮯',
		"ct_dots": 'Show hidden files">dotfiles',
		"ct_qdel": 'Quick delete without extra confirmations">qdel',
		"ct_dir1st": 'Show folders before files">📁 first',
		"ct_nsort": 'Sort numbers naturally (1, 2, 10 instead of 1, 10, 2)">nsort',
		"ct_utc": 'Show times in UTC timezone">UTC',
		"ct_readme": 'Show README files in folders">📜 readme',
		"ct_idxh": 'Show index.html if available">htm',
		...
		"tt_entree": "Show or hide folder tree",
		"tt_detree": "Show path as clickable links",
		"tt_visdir": "Find current folder in tree",
		"tt_ftree": "Show files in tree",
		"tt_pdock": "Keep parent folders visible",
		"tt_dynt": "Auto-expand panel",
		"tt_wrap": "Wrap long names",
		"tt_hover": "Show full names on hover",
