...
if (1)
	Ls.eng = {
		...
		"ot_unpost": "Delete or cancel your recent uploads",
		"ot_bup": "Simple file uploader",
		"ot_mkdir": "Create a new folder",
		"ot_md": "Create a new text file",
		...
		"wt_cut": "Cut selected files to move them",
		"wt_cpy": "Copy selected files",
		"wt_pst": "Paste files here",
		"wt_selall": "Select all files",
		"wt_selinv": "Flip selection (select unselected, unselect selected)",
		"wt_zip1": "Download this folder as a ZIP file",
		"wt_selzip": "Download selected files as a ZIP",
		"wt_seldl": "Download selected files separately",
		...
		"tt_entree": "Show folder navigation panel",
		"tt_detree": "Show folder path",
		"tt_visdir": "Jump to current folder in the tree",
		"tt_ftree": "Switch between folders and files view",
		"tt_pdock": "Pin parent folders at the top",
		"tt_dynt": "Auto-expand panel as needed",
